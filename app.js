...
// Listen for a submit
document.querySelector(".form-container1").addEventListener("submit", submitForm);
...
function submitForm(e) {
    ...
    document.querySelector(".form-container1").reset();
}
...
function sendEmail() {
    Email.send({
        ...
        Username: "shane.abrahams@younglings.africa",
        Password: "Password1",
        To: 'shane.abrahams@younglings.africa',
        From: "shane.abrahams@younglings.africa",
